...
__decorate([
    (0, typeorm_1.Column)({ type: String }),
    __metadata("design:type", String)
], Post.prototype, "postCategoryId", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => post_category_1.PostCategory, postCategory => postCategory.posts),
...
__decorate([
    (0, typeorm_1.ManyToMany)(() => post_tag_1.PostTag),
